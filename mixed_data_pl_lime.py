...
if __name__ == "__main__":
    ...
    analyzer = LocalModelStabilityAnalyzer(predict_fn, train, labels_train, instance,
                                           categorical_features=categorical_features,
                                           continuous_features=continuous_features, k1=20, N=50, n_perturbation=5000,
                                           n0=2, save_path="an0_4_xlime_results.csv")
    for k in [8,10,12,14]:
        analyzer.k1 = k
        analyzer.n0 = 1
